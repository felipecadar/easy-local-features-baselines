...
from easy_local_features.submodules.git_d2net.models import D2Net

class D2Net_baseline():
    def __init__(self, use_relu=True, device=-1):
...
if __name__ == "__main__":
    ...
    model = D2Net_baseline(device=0)

    kps1 = sift.detect(img1, None)
    kps2 = sift.detect(img2, None)

    _, desc1 = model.compute(img1, kps1)
    _, desc2 = model.compute(img2, kps2)
